...
*┗──────────────⊷*`;
        ...
        const newsletterContext = {
            ...
            forwardedNewsletterMessageInfo: {
                ...
                newsletterName: 'ᴘᴏᴡᴇʀᴇᴅ ʙʏ TimnasaTech',
                serverMessageId: -1
            }
        };
...
case 'bot_info': {
    try {
        ...
        const captionText = `
*┏────〘 TIMNASA-INFO 〙───⊷*
*┃*  👤 ɴᴀᴍᴇ: TimnasaTech ᴍɪɴɪ ʙᴏᴛ
*┃*  👑 ᴄʀᴇᴀᴛᴏʀ: ᴍᴀᴅᴇ ʙʏ Timoth ᴛᴇᴄʜ
*┃*  🌐 ᴠᴇʀsɪᴏɴ: ${config.version}
...
`;
    ...
    const messageContext = {
        ...
        forwardedNewsletterMessageInfo: {
            newsletterJid: '120363406146813524@newsletter',
            newsletterName: 'TimnasaTech ᴍɪɴɪ ʙᴏᴛ🌟',
            serverMessageId: -1
        }
    };
    ...
    const menuMessage = {
      image: { url: "https://files.catbox.moe/adzm0d.jpeg" },
      caption: `*👾 𝐓𝐈𝐌𝐍𝐀𝐒𝐀 𝐌𝐈𝐍 𝐁𝐎𝐓 👾*\n${menuText}`,
      buttons: [
        {
          buttonId: `${config.PREFIX}quick_commands`,
          buttonText: { displayText: '🤖 Timnasa ᴍɪɴɪ ᴄᴍᴅs' },
          type: 4,
          nativeFlowInfo: {
            name: 'single_select',
            paramsJson: JSON.stringify({
              title: '🤖 Timnasa ᴍɪɴɪ ᴄᴍᴅs',
              sections: [
                {
                  title: "🌐 ɢᴇɴᴇʀᴀʟ ᴄᴏᴍᴍᴀɴᴅs",
                  highlight_label: '© Timnasa ᴍɪɴɪ',
                  rows: [
                ...
                case 'fb': {
                    ...
                    try {
                        ...
                        await socket.sendMessage(sender, {
                            video: { url: result.sd },
                            mimetype: 'video/mp4',
                            caption: '> ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴛɪᴍɴᴀsᴀ ᴛᴍᴅ'
                        }, { quoted: fakevCard });
                ...
                case 'winfo': {
                    ...
                    if (inputNumber.length < 10) {
                        await socket.sendMessage(sender, {
                            ...
                            caption: formatMessage(
                                '❌ ERROR',
                                'That number’s too short, love! Try: .winfo +255784766591',
                                'ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴛɪᴍɴᴀsᴀ ᴛᴍᴅ'
                            )
                        });
                        break;
...
User Message: ${q}
    ...
    const messageContext = {
        ...
        forwardedNewsletterMessageInfo: {
            newsletterJid: '120363406146813524@newsletter',
            newsletterName: 'ᴛɪᴍɴᴀsᴀ ᴛᴍᴅ ᴍɪɴɪ ʙᴏᴛ🌟',
            serverMessageId: -1
        }
    };
...
//===============================
                  ...
                  await socket.sendMessage(sender, { react: { text: '🔮', key: msg.key } });
                    ...
                    try {
                        ...
                        await socket.sendMessage(sender, {
                            image: imageBuffer,
                            caption: `🧠 *ᴛɪᴍɴᴀsᴀ ᴛᴍᴅ_ᴍɪɴɪᴀɪ ɪᴍᴀɢᴇ*\n\n📌 ᴘʀᴏᴍᴘᴛ: ${prompt}`
                        }, { quoted: fakevCard });
                    } catch (err) {
                ...
                await socket.sendMessage(sender, { react: { text: '😅', key: msg.key } });
                    try {
                        ...
                        await socket.sendMessage(sender, {
                            image: { url: thumbnailUrl },
                            caption: formatMessage(
                                '📰 ᴛɪᴍɴᴀsᴀ ᴛᴍᴅ ᴍɪɴɪ ʙᴏᴛ  ɢᴏssɪᴘ ʟᴀᴛᴇsᴛ ɴᴇᴡs් 📰',
                                `📢 *${title}*\n\n${desc}\n\n🕒 *ᴅᴀᴛᴇ*: ${date || 'Not yet given'}\n🌐 *ʟɪɴᴋ*: ${link}`,
                                'ᴛɪᴍɴᴀsᴀ ᴛᴍᴅ ᴍɪɴɪ ʙᴏᴛ'
                            )
                        });
                    } catch (error) {
        ...
        const repoMessage = {
            ...
            contextInfo: {
                ...
                forwardedNewsletterMessageInfo: {
                    ...
                    newsletterName: 'ᴛɪᴍɴᴀsᴀ ᴛᴍᴅ-ʀᴇᴘᴏ',
                    serverMessageId: 143
                }
            }
        };
...
case 'repo-visit': {
    await socket.sendMessage(sender, { react: { text: '🌐', key: msg.key } });
    await socket.sendMessage(sender, {
        text: `🌐 *ᴄʟɪᴄᴋ ᴛᴏ ᴠɪsɪᴛ ᴛʜᴇ ʀᴇᴘᴏ:*\https://github.com/timnasax/TIMNASA_TMD1`,
        contextInfo: {
            externalAdReply: {
...
case 'repo-owner': {
    await socket.sendMessage(sender, { react: { text: '👑', key: msg.key } });
    await socket.sendMessage(sender, {
        text: `👑 *Click to visit the owner profile:*\https://github.com/timnasax/TIMNASA_TMD1`,
        contextInfo: {
            externalAdReply: {
                title: 'Owner Profile',
                body: 'Open in browser',
